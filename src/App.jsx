    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/done" element={<DashboardLayout />}>
          <Route index element={<Navigate to="financial-crime" replace />} />
          <Route path="financial-crime" element={
            <ProcessList key="financial-crime" title="Financial Crime Detection" category="Financial Crime Detection" />
          } />
